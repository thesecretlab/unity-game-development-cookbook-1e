...
For example, you can sue a quaternion to define a rotation that rotates around 90 degrees on the X axis:
...
----
!!!!!!!!
No code found for query 'quaternions5' at ref 'HEAD'. Possible replacement tags
include: quaternions, quaternions4, quaternions1, quaternions2,
quaternions3_identity
!!!!!!!!
----
