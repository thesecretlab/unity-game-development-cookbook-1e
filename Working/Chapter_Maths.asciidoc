...
----
!!!!!!!!
No code found for query 'dot_product' at ref 'HEAD'. Possible replacement tags
include: dot_product                     , dot_product3                  ,
dot_product2                  , dot_product4                  , dot_product5
!!!!!!!!
----
...
----
!!!!!!!!
No code found for query 'dot_product2' at ref 'HEAD'. Possible replacement tags
include: dot_product2                   , dot_product                   ,
dot_product3                  , dot_product4                  , dot_product5
!!!!!!!!
----
...
----
!!!!!!!!
No code found for query 'dot_product3' at ref 'HEAD'. Possible replacement tags
include: dot_product3                   , dot_product                   ,
dot_product2                  , dot_product4                  , dot_product5
!!!!!!!!
----
...
----
!!!!!!!!
No code found for query 'dot_product4' at ref 'HEAD'. Possible replacement tags
include: dot_product4                   , dot_product                   ,
dot_product3                  , dot_product2                  , dot_product5
!!!!!!!!
----
...
----
!!!!!!!!
No code found for query 'dot_product5' at ref 'HEAD'. Possible replacement tags
include: dot_product5                   , dot_product                   ,
dot_product3                  , dot_product2                  , dot_product4
!!!!!!!!
----
